  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center justify-center h-screen mt-4">
        <h1 className="text-4xl font-medium">Apply Here for loan</h1>
        <form className="mt-10 text-xl w-96 flex flex-col gap-4">
          ...
          <button onClick={onHandleClick} className="bg-indigo-500 px-4 py-2 text-white rounded hover:bg-indigo-600">
            Get Money
          </button>
        </form>
      </main>
